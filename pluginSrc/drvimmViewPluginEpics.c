...
static const iocshArg * const initArgs[] = {&initArg0,
                                            ...
                                            &initArg5,
                                            &initArg6};
static const iocshFuncDef initFuncDef = {"drvimmViewPluginConfigure",7,initArgs};
static void initCallFunc(const iocshArgBuf *args)
{
    drvimmViewPluginConfigure(args[0].sval, args[1].ival, args[2].ival, args[3].sval, args[4].ival, args[5].ival, args[6].ival);
}

void immViewPluginRegister(void)
{
    iocshRegister(&initFuncDef,initCallFunc);
}

epicsExportRegistrar(immViewPluginRegister);
