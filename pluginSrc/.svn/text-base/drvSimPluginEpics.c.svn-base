...
static const iocshArg * const initArgs[] = {&initArg0,
                                            ...
                                            &initArg5,
                                            &initArg6};
static const iocshFuncDef initFuncDef = {"drvSimPluginConfigure",7,initArgs};
static void initCallFunc(const iocshArgBuf *args)
{
    drvSimPluginConfigure(args[0].sval, args[1].ival, args[2].ival, args[3].sval, args[4].ival, args[5].ival, args[6].ival);
}

void simPluginRegister(void)
{
    iocshRegister(&initFuncDef,initCallFunc);
}

epicsExportRegistrar(simPluginRegister);
