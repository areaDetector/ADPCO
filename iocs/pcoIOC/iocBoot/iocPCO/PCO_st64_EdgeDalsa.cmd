...
PCOConfig("PCOIOC", "SERIAL",$(QSIZE), 500,50,0)
...
dbLoadRecords("$(AREA_DETECTOR)/ADApp/Db/NDPluginBase.template","P=PCOIOC2:,R=EDGEDSC:,PORT=EDGEDSC,ADDR=0,TIMEOUT=1,NDARRAY_PORT=PCOIOC,NDARRAY_ADDR=0")
dbLoadRecords("$(ADIOCs)/Db/pcoEdgePlugin.template",     "P=PCOIOC2:,R=EDGEDSC:,PORT=EDGEDSC,ADDR=0,TIMEOUT=1")
...
dbLoadRecords("$(AREA_DETECTOR)/ADApp/Db/NDPluginBase.template","P=PCOIOC2:,R=image1:,PORT=PCOIOCImage,ADDR=0,TIMEOUT=1,NDARRAY_PORT=EDGEDSC,NDARRAY_ADDR=0")
...
dbLoadRecords("$(AREA_DETECTOR)/ADApp/Db/NDPluginBase.template","P=PCOIOC2:,R=TIFF1:,PORT=TIFF1,ADDR=0,TIMEOUT=1,NDARRAY_PORT=EDGEDSC,NDARRAY_ADDR=0")
...
dbLoadRecords("$(AREA_DETECTOR)/ADApp/Db/NDPluginBase.template","P=PCOIOC2:,R=HDF5:,PORT=HDF5,ADDR=0,TIMEOUT=1,NDARRAY_PORT=EDGEDSC,NDARRAY_ADDR=0")
...
dbLoadRecords("$(AREA_DETECTOR)/ADApp/Db/NDPluginBase.template","P=PCOIOC2:,R=ROI1:,  PORT=ROI1,ADDR=0,TIMEOUT=1,NDARRAY_PORT=EDGEDSC,NDARRAY_ADDR=0")
...
dbLoadRecords("$(AREA_DETECTOR)/ADApp/Db/NDPluginBase.template","P=PCOIOC2:,R=DUM:,PORT=DUM,ADDR=0,TIMEOUT=1,NDARRAY_PORT=EDGEDSC,NDARRAY_ADDR=0")
dbLoadRecords("$(AREA_DETECTOR)/ADApp/Db/NDFile.template",      "P=PCOIOC2:,R=DUM:,PORT=DUM,ADDR=0,TIMEOUT=1")
dbLoadRecords("$(ADIOCs)/Db/simPlugin.template", "P=PCOIOC2:,R=DUM:,PORT=DUM,ADDR=0,TIMEOUT=1")
...
dbpf "PCOIOC2:cam1:cor_ccf_filename","D:/corecofiles/pco10Tap.ccf"
#dbpf "PCOIOC2:cam1:cor_ccf_filename","D:/corecofiles/timmaddenedge.mcf"

#needed for edge- for rolling / global shutter mode
#dbpf "PCOIOC2:cam1:pco_rollshut_mcfname","D:/corecofiles/timmaddenedge.mcf"
#dbpf "PCOIOC2:cam1:pco_globshut_mcfname","D:/corecofiles/edgeGlobShutter.mcf"

dbpf "PCOIOC2:cam1:pco_rollshut_mcfname","D:/corecofiles/pco10Tap.ccf"
dbpf "PCOIOC2:cam1:pco_globshut_mcfname","D:/corecofiles/pco10Tap.ccf"
